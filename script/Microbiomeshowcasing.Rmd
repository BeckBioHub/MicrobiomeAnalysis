...
# QC & filtering (showcase-friendly)
...
library(DESeq2)
library(phyloseq)
# Agglomerate to Genus (optional: can also do Phylum, Family, or keep ASVs)
...
ggsave("figures/Combi.png", combined1, width=15, height=15, dpi=300)
